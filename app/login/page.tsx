        ...
        <div className="w-full max-w-md overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-2xl shadow-sky-100">
          ...
          <div className="px-8 py-8 sm:px-10">
            ...
            <button
              type="button"
              disabled
              className="flex w-full cursor-not-allowed items-center justify-center gap-3 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-semibold text-slate-400"
            >
            ...
            <p className="mt-2 text-center text-xs text-slate-500">
              Google Login will be available after authentication setup.
            </p>
